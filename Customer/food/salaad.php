  ...
  ?>
      <tr class="hover:bg-gray-50">
        <th class="flex gap-3 px-6 py-4 font-normal text-gray-900">
          ...
          <div class="text-sm">
            <div class="font-medium text-gray-700"><?php echo $salaad['name'];  ?></div>
          </div>
        </th>
        <td class="px-6 py-4">
          <span
          ...
          >
            ...
            <?php echo $salaad['price'];  ?>
          </span>
        </td>
        <td class="px-6 py-4"><?php echo $salaad['quantity'];  ?></td>
        <td class="px-6 py-4">
